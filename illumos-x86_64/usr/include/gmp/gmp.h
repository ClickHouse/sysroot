...
#define __GMP_CC "/opt/gcc-14/bin/gcc"
#define __GMP_CFLAGS "-O2 -fno-omit-frame-pointer -fno-aggressive-loop-optimizations -fstack-protector-strong -fexceptions -gdwarf-4 -gstrict-dwarf  -m64"
