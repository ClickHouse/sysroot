...
/* Define if compiling with the kernel_sunos5 module files.  */
#define USING_KERNEL_SUNOS5_MODULE 1
 
/* Define if compiling with the mibII/data_access/at_solaris module files.  */
#define USING_MIBII_DATA_ACCESS_AT_SOLARIS_MODULE 1
...
/* Define if compiling with the hardware/memory/memory_solaris module files.  */
#define USING_HARDWARE_MEMORY_MEMORY_SOLARIS_MODULE 1
...
/* Define if compiling with the host/data_access/swrun_procfs_psinfo module files.  */
#define USING_HOST_DATA_ACCESS_SWRUN_PROCFS_PSINFO_MODULE 1
 
/* Define if compiling with the hardware/cpu/cpu module files.  */
#define USING_HARDWARE_CPU_CPU_MODULE 1
 
/* Define if compiling with the hardware/cpu/cpu_kstat module files.  */
#define USING_HARDWARE_CPU_CPU_KSTAT_MODULE 1
...
/* Define if compiling with the tcp-mib/data_access/tcpConn_solaris2 module files.  */
#define USING_TCP_MIB_DATA_ACCESS_TCPCONN_SOLARIS2_MODULE 1
...
/* Define if compiling with the ip-mib/data_access/systemstats_solaris2 module files.  */
#define USING_IP_MIB_DATA_ACCESS_SYSTEMSTATS_SOLARIS2_MODULE 1
...
/* Define if compiling with the if-mib/data_access/interface_solaris2 module files.  */
#define USING_IF_MIB_DATA_ACCESS_INTERFACE_SOLARIS2_MODULE 1
...
/* Define if compiling with the udp-mib/data_access/udp_endpoint_solaris2 module files.  */
#define USING_UDP_MIB_DATA_ACCESS_UDP_ENDPOINT_SOLARIS2_MODULE 1
...
/* Define if compiling with the ip-mib/data_access/ipaddress_solaris2 module files.  */
#define USING_IP_MIB_DATA_ACCESS_IPADDRESS_SOLARIS2_MODULE 1
...
/* Define if compiling with the ip-mib/data_access/defaultrouter_solaris2 module files.  */
#define USING_IP_MIB_DATA_ACCESS_DEFAULTROUTER_SOLARIS2_MODULE 1
...
/* Define if compiling with the ip-forward-mib/data_access/route_solaris module files.  */
#define USING_IP_FORWARD_MIB_DATA_ACCESS_ROUTE_SOLARIS_MODULE 1
