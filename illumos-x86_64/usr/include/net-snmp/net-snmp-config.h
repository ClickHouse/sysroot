...
#define HAVE_SECURITY_CRYPTOKI_H 1
...
#define NETSNMP_DEFAULT_MIBDIRS "/etc/net-snmp/snmp/mibs"
...
#define NETSNMP_SYSTEM_INCLUDE_FILE "net-snmp/system/solaris.h"
...
#define SNMPLIBPATH "/usr/lib/amd64/snmp"
#define SNMPSHAREPATH "/etc/net-snmp/snmp"
#define SNMPCONFPATH "/etc/snmp"
#define SNMPDLMODPATH "/usr/lib/amd64/snmp/dlmod"
