...
#define __GMP_CC "s390x-linux-gnu-gcc"
#define __GMP_CFLAGS "-g -O2 -fdebug-prefix-map=/build/gmp-8QH46c/gmp-6.1.2+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security -O3"
